...
class PedidoServiceTest {
    ...
    void testCrearPedido_EstadoActivo_NotificaWhatsApp() {
        ...
        // Assert
        verify(whatsAppService).notificarNuevoPedidoActivo(any(Pedido.class));
    }
    ...
    void testActualizarEstado_Exitoso() {
        ...
        verify(whatsAppService).notificarCambioEstadoPedido(any(Pedido.class), eq("CRT"));
    }
    ...
    void testCancelarPedido_Exitoso() {
        ...
        verify(whatsAppService).notificarCancelacionPedido(any(Pedido.class));
    }
